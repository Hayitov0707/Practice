...
public class ClassAnalyzer
{
    ...
    public IEnumerable<string> GetMethodParams(string methodname)
    {
        ...
        var returnStr = $"Return: {method.ReturnType.Name}";
        
        var paramsStr = method.GetParameters().Select(p => $"{p.ParameterType.Name} {p.Name}");

        return new[] { returnStr }.Concat(paramsStr);
    }
